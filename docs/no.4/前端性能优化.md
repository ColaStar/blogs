...
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/Navigation_Timing.png">![](http://blog.colastar.club:9527/static/images/Navigation_Timing.png)</a>
...
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/navgation_timing1.png">![](http://blog.colastar.club:9527/static/images/navgation_timing1.png)</a>
- 敲下回车
...
**浏览器解析文档生成DOM Tree，要经历以下步骤**

**Bytes => Characters => Token => Node => DOM 即：**

    - 将原始字节（传输的数据都是0和1），根据指定编码形式转化为字符串（程序员所写的代码）
    - 将字符串转为Token，如< body >,< head >之类的
    - 生成token的同时，也消耗token并构建成Node节点
    - 生成DOM

<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/DOM树形结构.png">![](http://blog.colastar.club:9527/static/images/DOM树形结构.png)</a>
- 二.是CSS，解析CSS会产生CSS规则树，它和DOM结构比较像。
    **浏览器解析CSS生成CSSOM Tree，要经历以下步骤：**
    **Bytes => Characters => Token => Node => CSSOM**

**CSS会阻塞文档的解析**

```
上面提到，解析的JavaScript，可以操作DOM，也可以操作CSSOM。那么，如果JavaScript需要去更改样式，即操作CSSOM，则它需要得到完整的CSSOM Rule Tree。不完整的CSSOM Rule Tree，JavaScript是无法操纵的。

所以，如果CSSOM还未完成构建，而JavaScript又想操作CSSOM，则会先加载解析CSS，完成CSSOM的构建，再执行JavaScript，最后再恢复DOM的解析构建。
```

<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/css规则树.png">![](http://blog.colastar.club:9527/static/images/css规则树.png)</a>

- 三.是Javascript脚本，等到Javascript 脚本文件加载后， 通过 DOM API 和 CSSOM API 来操作 DOM Tree 和 CSS Rule Tree。

**在解析文档，构建DOM Tree的时候，如果遇到了JS文件，会发生以下几个事情：**

    - 暂停对文档的解析，即停止构建DOM Tree
    - 将控制权交给JavaScript引擎
    - 待JavaScript加载、解析与执行完毕后，再恢复解析文档。
    - 也就是说，JS文件是会阻塞文档的解析的 。

<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/Javascript脚本.png">![](http://blog.colastar.club:9527/static/images/Javascript脚本.png)</a>
...
http2的多路复用
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/http2多路复用1.png">![](http://blog.colastar.club:9527/static/images/http2多路复用1.png)</a>

<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/性能优化.png">![](http://blog.colastar.club:9527/static/images/性能优化.png)</a>
...
记录类型
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/dns_histrory.png">![](http://blog.colastar.club:9527/static/images/dns_histrory.png)</a>
注意：
...
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/dns_historoy2.png">![](http://blog.colastar.club:9527/static/images/dns_historoy2.png)</a>

#### TCP三次握手与四次挥手

<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/tcp三次握手与四次挥手.png">![](http://blog.colastar.club:9527/static/images/tcp三次握手与四次挥手.png)</a>
...
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/TCP协议模型的详解.png">![](http://blog.colastar.club:9527/static/images/TCP协议模型的详解.png)</a>

ping命令用的ICMP协议（数据报协议）
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/tcp协议头.png">![](http://blog.colastar.club:9527/static/images/tcp协议头.png)</a>
...
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/cdn.png">![](http://blog.colastar.club:9527/static/images/cdn.png)</a>
...
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/cdn缓存.png">![](http://blog.colastar.club:9527/static/images/cdn缓存.png)</a>
...
缓存优先级
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/缓存优先级.png">![](http://blog.colastar.club:9527/static/images/缓存优先级.png)</a>

浏览器第一次请求流程图
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/请求缓存的流程2.png">![](http://blog.colastar.club:9527/static/images/请求缓存的流程2.png)</a>
浏览器再次请求时
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/请求缓存的流程2.png">![](http://blog.colastar.club:9527/static/images/请求缓存的流程2.png)</a>
缓存会根据请求保存输出内容的副本，例如html页面，图片，文件，当下一个请求来到的时候:如果是相同的URL，缓存直接使用副本响应访问请求，而不是向源服务器再次发送请求，。
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/用户行为与缓存.png">![](http://blog.colastar.club:9527/static/images/用户行为与缓存.png)</a>
浏览器缓存行为还有用户的行为有关
...
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/缓存机制.png">![](http://blog.colastar.club:9527/static/images/缓存机制.png)</a>
...
- 3.CSS3硬件加速 ： `translate`属性值来替换`top/left/right/bottom`的切换，`scale`属性值替换`width/height`，`opacity`属性替换`display/visibility`等等
...
- **8.使DOM脱离文档流，再作批量处理 （建立子树，显示隐藏，新节点替换）**
...
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/fp.png">![](http://blog.colastar.club:9527/static/images/fp.png)</a>
- FCP：First Contentful Paint, ⾸次有内容的绘制（包含⻚页⾯面的基本框架，但没有数据内容）
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/fcp.png">![](http://blog.colastar.club:9527/static/images/fcp.png)</a>
- FMP：First Meaningful Paint,⾸次有意义的绘制（包含页⾯所有元素及数据）
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/fmp.png">![](http://blog.colastar.club:9527/static/images/fmp.png)</a>
- TTI：Time To Interactive, 可交互时间 

<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/fmp.png">![](http://blog.colastar.club:9527/static/images/fmp.png)</a>
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/fp_fcp_fmp.png">![](http://blog.colastar.club:9527/static/images/fp_fcp_fmp.png)</a>
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/fp_fcp_fmp2.png">![](http://blog.colastar.club:9527/static/images/fp_fcp_fmp2.png)</a>

Long Task的表现
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/long_task.png">![](http://blog.colastar.club:9527/static/images/long_task.png)</a>

关于VUE的执行
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/vue_fp_fcp_fmp.png">![](http://blog.colastar.club:9527/static/images/vue_fp_fcp_fmp.png)</a>
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/vue_fp_fcp_fmp2.png">![](http://blog.colastar.club:9527/static/images/vue_fp_fcp_fmp2.png)</a>

问题：为啥会出现白屏
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/白屏原因.png">![](http://blog.colastar.club:9527/static/images/白屏原因.png)</a>

#### CSR与SSR

<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/优化总结.png">![](http://blog.colastar.club:9527/static/images/优化总结.png)</a>
