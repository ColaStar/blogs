...
```
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/basketjs1.png">![](http://blog.colastar.club:9527/static/images/basketjs1.png)</a>

第一次加载，由于helloworld.js 只有一行代码alert('hello world');， 所以运行该demo时就会弹出 "hello world"。并且对应的 js 会被保存到 LocalStorage：
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/basketjs2.png">![](http://blog.colastar.club:9527/static/images/basketjs2.png)</a>


此时对应的资源加载情况：

<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/basketjs3.png">![](http://blog.colastar.club:9527/static/images/basketjs3.png)</a>


刷新一次页面，再查看一次资源的加载情况：
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/basketjs4.png">![](http://blog.colastar.club:9527/static/images/basketjs4.png)</a>

可以看到已经没有再发送 helloworld.js 相关的请求，因为 LocalStorage 上已经有对应的缓存了，直接从本地获取即可。

## 三、实现流程
流程图
<a data-fancybox title="" href="http://blog.colastar.club:9527/static/images/basketjs5.png">![](http://blog.colastar.club:9527/static/images/basketjs5.png)</a>
