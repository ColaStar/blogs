...
module.exports = {
  ...
  head: [
    ['link', {
      rel: 'icon',
      href: `https://colastar.github.io/blogs/views/images/favicon.ico`
    }],
    ['link', {
      rel: 'manifest',
      href: 'https://colastar.github.io/blogs/views/js/manifest.json'
    }],
    ['link', {
      rel: 'apple-touch-icon',
      href: 'https://colastar.github.io/blogs/views/images/logo.png'
    }],
