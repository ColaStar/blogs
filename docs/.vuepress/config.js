    ...
    nav: [
      ...
      { text: '博文',
        items: [
          ...
          { text: '网络', link: '/no.2/http' },
          { text: '前端自动化', link: '/no.3/webpack' },
          { text: '前端优化', link: '/no.4/前端性能优化' },
          { text: 'css相关', link: '/no.5/css工作流' },
          { text: '框架相关', link: '/no.6/react/react' },
          { text: '跨界', link: '/no.7/计算机组成原理' },
          { text: '数据结构与算法', link: '/no.8/数据结构与算法' },
          { text: 'node相关', link: '/node/node/node' },
          { text: '其他相关', link: '/other/git/git命令全集' },
        ] 
      },
      { text: '面试', link: '/no.1/' },
