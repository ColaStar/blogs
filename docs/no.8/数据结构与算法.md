...
- 算法
- 前端中的数据结构和算法
<a data-fancybox title="数据结构与算法体系图" href="http://blog.colastar.club:9527/static/images/数据结构与算法体系图.png">![数据结构与算法体系图](http://blog.colastar.club:9527/static/images/数据结构与算法体系图.png)</a>
...
<a data-fancybox title="算法1" href="http://blog.colastar.club:9527/static/images/算法1.png">![算法1](http://blog.colastar.club:9527/static/images/算法1.png)</a>
...
<a data-fancybox title="算法2" href="http://blog.colastar.club:9527/static/images/算法2.png">![算法2](http://blog.colastar.club:9527/static/images/算法2.png)</a>
...
<a data-fancybox title="逻辑结构图解" href="http://blog.colastar.club:9527/static/images/逻辑结构图解.png">![逻辑结构图解](http://blog.colastar.club:9527/static/images/逻辑结构图解.png)</a>
...
<a data-fancybox title="集合" href="http://blog.colastar.club:9527/static/images/集合.png">![集合](http://blog.colastar.club:9527/static/images/集合.png)</a>
...
<a data-fancybox title="一维数组数据结构" href="http://blog.colastar.club:9527/static/images/一维数组数据结构.png">![一维数组数据结构](http://blog.colastar.club:9527/static/images/一维数组数据结构.png)</a>

<a data-fancybox title="一维数组数据结构1" href="http://blog.colastar.club:9527/static/images/一维数组数据结构1.png">![一维数组数据结构1](http://blog.colastar.club:9527/static/images/一维数组数据结构1.png)</a>

**优势：**

数组，则很方便读取每一个元素的内容。因为知道第一个，就知道了所有的地址。它们是连在一起的。

<a data-fancybox title="一维数组数据结构2" href="http://blog.colastar.club:9527/static/images/一维数组数据结构2.png">![一维数组数据结构2](http://blog.colastar.club:9527/static/images/一维数组数据结构2.png)</a>
...
<a data-fancybox title="链表数据结构" href="http://blog.colastar.club:9527/static/images/链表数据结构.png">![链表数据结构](http://blog.colastar.club:9527/static/images/链表数据结构.png)</a>

<a data-fancybox title="链表数据结构1" href="http://blog.colastar.club:9527/static/images/链表数据结构1.png">![链表数据结构1](http://blog.colastar.club:9527/static/images/链表数据结构1.png)</a>
...
<a data-fancybox title="单链表" href="http://blog.colastar.club:9527/static/images/单链表结构图.png">![单链表](http://blog.colastar.club:9527/static/images/单链表结构图.png)</a>

只能朝一个方向进行遍历（接着后继元素一个一个的遍历，结构相对简单只有后继指针，操作时只需要断一个）

<a data-fancybox title="双向链表" href="http://blog.colastar.club:9527/static/images/双链表结构.png">![双向链表](http://blog.colastar.club:9527/static/images/双链表结构.png)</a>

可以从俩个方向遍历，因为有俩个指针，操作起来麻烦，需要操作俩次

> 数组与链表时间复杂度比较

<a data-fancybox title="数组与链表时间复杂度比较" href="http://blog.colastar.club:9527/static/images/数组与链表时间复杂度比较.png">![数组与链表时间复杂度比较](http://blog.colastar.club:9527/static/images/数组与链表时间复杂度比较.png)</a>
...
<a data-fancybox title="栈数据结构" href="http://blog.colastar.club:9527/static/images/栈数据结构.png">![栈数据结构](http://blog.colastar.club:9527/static/images/栈数据结构.png)</a>
...
<a data-fancybox title="队列数据结构" href="http://blog.colastar.club:9527/static/images/队列数据结构.png">![队列数据结构](http://blog.colastar.club:9527/static/images/队列数据结构.png)</a>
...
<a data-fancybox title="树数据结构" href="http://blog.colastar.club:9527/static/images/树数据结构.png">![树数据结构](http://blog.colastar.club:9527/static/images/树数据结构.png)</a>
...
<a data-fancybox title="分辨是不是树" href="http://blog.colastar.club:9527/static/images/分辨是不是树.png">![分辨是不是树](http://blog.colastar.club:9527/static/images/分辨是不是树.png)</a>
...
<a data-fancybox title="先序遍历" href="http://blog.colastar.club:9527/static/images/先序遍历.png">![先序遍历](http://blog.colastar.club:9527/static/images/先序遍历.png)</a>

<a data-fancybox title="先序遍历1" href="http://blog.colastar.club:9527/static/images/先序遍历1.png">![先序遍历1](http://blog.colastar.club:9527/static/images/先序遍历1.png)</a>
...
<a data-fancybox title="中序遍历" href="http://blog.colastar.club:9527/static/images/中序遍历.png">![中序遍历](http://blog.colastar.club:9527/static/images/中序遍历.png)</a>

<a data-fancybox title="中序遍历1" href="http://blog.colastar.club:9527/static/images/中序遍历1.png">![中序遍历1](http://blog.colastar.club:9527/static/images/中序遍历1.png)</a>
...
<a data-fancybox title="后序遍历" href="http://blog.colastar.club:9527/static/images/后序遍历.png">![后序遍历](http://blog.colastar.club:9527/static/images/后序遍历.png)</a>

<a data-fancybox title="后序遍历1" href="http://blog.colastar.club:9527/static/images/后序遍历1.png">![后序遍历1](http://blog.colastar.club:9527/static/images/后序遍历1.png)</a>
...
<a data-fancybox title="层序遍历" href="http://blog.colastar.club:9527/static/images/层序遍历.png">![层序遍历](http://blog.colastar.club:9527/static/images/层序遍历.png)</a>
...
[通用树的实现](http://blog.colastar.club:9527/static/images/https://blog.51cto.com/11134889/2140088)
...
<a data-fancybox title="哈夫曼树(数字大小代表权重)" href="数字大小代表权重">![哈夫曼树(数字大小代表权重)](http://blog.colastar.club:9527/static/images/哈夫曼树.png)</a>
...
<a data-fancybox title="顺序结构" href="http://blog.colastar.club:9527/static/images/顺序结构.png">![顺序结构](http://blog.colastar.club:9527/static/images/顺序结构.png)</a>
...
<a data-fancybox title="链接存储" href="http://blog.colastar.club:9527/static/images/链接存储.png">![链接存储](http://blog.colastar.club:9527/static/images/链接存储.png)</a>
...
<a data-fancybox title="索引存储" href="http://blog.colastar.club:9527/static/images/索引存储.png">![索引存储](http://blog.colastar.club:9527/static/images/索引存储.png)</a>
...
<a data-fancybox title="散列存储" href="http://blog.colastar.club:9527/static/images/散列存储.png">![散列存储](http://blog.colastar.club:9527/static/images/散列存储.png)</a>
...
<a data-fancybox title="常见算法复杂度" href="http://blog.colastar.club:9527/static/images/常见算法复杂度.png">![常见算法复杂度](http://blog.colastar.club:9527/static/images/常见算法复杂度.png)</a>
...
<a data-fancybox title="计算复杂度" href="http://blog.colastar.club:9527/static/images/计算复杂度.png">![计算复杂度](http://blog.colastar.club:9527/static/images/计算复杂度.png)</a>
...
<a data-fancybox title="排序算法" href="http://blog.colastar.club:9527/static/images/排序算法.png">![排序算法](http://blog.colastar.club:9527/static/images/排序算法.png)</a>

> 查找算法

<a data-fancybox title="查找算法" href="http://blog.colastar.club:9527/static/images/查找算法.png">![查找算法](http://blog.colastar.club:9527/static/images/查找算法.png)</a>
...
在数据集中找一个基准，所有小于基准的放左边，大于基准的放右边
不断重复，直到剩下最后一个元素为止
具体实现最好用循环而不是递归，容易爆栈
...
3.while
每次取最中间的那个
先看要查找的元素大于还是小于，如果小于再冲第一个和最中间的这个元素的最中间的那个，一直如此，直到最后一个元素

背包问题，找零问题是贪心算法

先对数组已经排序

function a(arr,n,sum){
