...
载，我们以后的课程中会⽤用到。
     ...
     <a data-fancybox title="centos源地址" href="http://blog.colastar.club:9527/static/images/linux_adderss.png">![centos源地址](http://blog.colastar.club:9527/static/images/linux_adderss.png)</a>
...
<a data-fancybox title="sub" href="http://blog.colastar.club:9527/static/images/sublinepng.png">![sub](http://blog.colastar.club:9527/static/images/sublinepng.png)</a>
```
# 解压缩
...
```
<a data-fancybox title="sub" href="http://blog.colastar.club:9527/static/images/zippng.png">![sub](http://blog.colastar.club:9527/static/images/zippng.png)</a>
>3.安装 XAMPP 集成开发环境
